return {
  ...
  opts = {
    ...
    scroll = {
      ...
      -- Custom timing for repeated scrolls
      animate_repeat = {
        delay = 50,
        duration = { step = 3, total = 10 },
        easing = "linear",
      },
    },
    statuscolumn = {
  ...
  keys = {
    ...
    { "<leader>pss",     function() Snacks.picker.grep() end,                                    desc = "Grep" },
    { "<leader>psh",     function() Snacks.picker.grep({ hidden = true }) end,                   desc = "Grep Hidden" },
    ...
    { "<leader>ph",      function() Snacks.picker.files({ hidden = true, ignored = true }) end,  desc = "Find Hidden Files" },
    ...
    { "<leader>vws",     function() Snacks.picker.lsp_workspace_symbols() end,                   desc = "LSP Workspace Symbols" },
