...
if [ "$CATPPUCCIN_FLAVOR" = "frappe" ]; then
    source ${0:A:h}/catppuccin/catppuccin-frappe.zsh
elif [ "$CATPPUCCIN_FLAVOR" = "latte" ]; then
    source ${0:A:h}/catppuccin/catppuccin-latte.zsh
elif [ "$CATPPUCCIN_FLAVOR" = "macchiato" ]; then
    source ${0:A:h}/catppuccin/catppuccin-macchiato.zsh
else
    source ${0:A:h}/catppuccin/catppuccin-mocha.zsh
fi
...
ZSH_AUTOSUGGEST_HIGHLIGHT_STYLE="fg=${catppuccin_surface1}"
